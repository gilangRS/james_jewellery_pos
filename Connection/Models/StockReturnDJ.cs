...
{
    public partial class StockReturnDJ
    {
        public StockReturnDJ()
        {
            StockReturnDJ_Products = new HashSet<StockReturnDJ_Product>();
        }
        ...
        public virtual ICollection<StockReturnDJ_Product> StockReturnDJ_Products { get; set; }
    }
}
