...
{
    public partial class PricingTableUS
    {
        public PricingTableUS()
        {
            PricingLogUSes = new HashSet<PricingLogUS>();
        }
        ...
        public virtual ICollection<PricingLogUS> PricingLogUSes { get; set; }
    }
}
