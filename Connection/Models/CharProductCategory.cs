...
{
    public partial class CharProductCategory
    {
        public CharProductCategory()
        {
            ASPDJLogs = new HashSet<ASPDJLog>();
            ASPDJs = new HashSet<ASPDJ>();
            ASPGJLogs = new HashSet<ASPGJLog>();
            ASPGJs = new HashSet<ASPGJ>();
            ASPLDLogs = new HashSet<ASPLDLog>();
            ASPLDs = new HashSet<ASPLD>();
            ...
            PointRewardDJs = new HashSet<PointRewardDJ>();
            PointRewardGJs = new HashSet<PointRewardGJ>();
        ...
        public string KodeProto { get; set; }

        public virtual ICollection<ASPDJLog> ASPDJLogs { get; set; }
        public virtual ICollection<ASPDJ> ASPDJs { get; set; }
        public virtual ICollection<ASPGJLog> ASPGJLogs { get; set; }
        public virtual ICollection<ASPGJ> ASPGJs { get; set; }
        public virtual ICollection<ASPLDLog> ASPLDLogs { get; set; }
        public virtual ICollection<ASPLD> ASPLDs { get; set; }
        ...
        public virtual ICollection<PointRewardDJ> PointRewardDJs { get; set; }
        public virtual ICollection<PointRewardGJ> PointRewardGJs { get; set; }
